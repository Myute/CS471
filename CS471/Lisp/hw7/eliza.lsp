;; cs471 Yoshii - Eliza Example -- call (main) to start 
...
;; added patient 1
(setf (get 'todd 'age) 100)
(setf (get 'todd 'MS)  'single)
(setf (get 'todd 'kids) 100)
;; added patient 2
(setf (get 'amelia 'age) 22)
(setf (get 'amelia 'MS)  'single)
(setf (get 'amelia 'kids) 0)
...
(defun response-to (a)
 ...
 ;; ** add another condition here that is not covered by the above 
    ( (member 'feel a) '(Why do you think you think that is?) )
